...
<a data-toggle="modal" data-target="#myModal"  class ='btn btn-sm btn-danger'>Kosongkan Pesanan</a>
<button class='btn btn-sm btn-success'  type="submit">Update Pesanan</button>
...
<?php
		...
		{
			echo "<h3>Keranjang Pesanan masih kosong</h3>";	
		}	
?>
</form>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			Anda yakin mau mengosongkan pesaanan Anda?
